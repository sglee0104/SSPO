...
class RLHFArguments:
    ...
    sspo_prior: Optional[float] = field(
        default=0.5,
        metadata={"help": "The prior parameter for SSPO training."}
    )
    sspo_gamma_min: Optional[float] = field(
        default=0.2,
        metadata={"help": "The gamma parameter for SSPO training to balance labeled and unlabeled loss."}
    )
    sspo_gamma_0: Optional[float] = field(
        default=1.0,
        metadata={"help": "The initial gamma value for adaptive gamma scheduler."}
    )
    sspo_gamma_decay: Optional[float] = field(
        default=0.001,
    ...
    #! EDIT : add adaptive gamma scheduler for SSPO training
    adaptive_gamma: Optional[bool] = field(
        default=False,
        metadata={"help": "Whether to use adaptive gamma scheduler for SSPO training."}
    )
    gamma_0: Optional[float] = field(
        default=1.0,
        metadata={"help": "The initial gamma value for adaptive gamma scheduler."}
    )
    gamma_min: Optional[float] = field(
        default=0.1,
        metadata={"help": "The minimum gamma value for adaptive gamma scheduler, recommended to set as labeled_data_ratio."}
    )
    gamma_decay: Optional[float] = field(
        default=0.005,
        metadata={"help": "The decay rate for adaptive gamma scheduler."}
    )
